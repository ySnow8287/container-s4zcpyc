...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s4zcpyc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s4zcpyc.containers.anotherwebservice.com/
...
```
git clone git@github.com:ySnow8287/container-s4zcpyc.git
cd container-s4zcpyc
```
...
```
docker attach container-s4zcpyc
```
